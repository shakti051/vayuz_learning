...
import 'package:vlcc/screens/appointments/appointment_history.dart';
      ...
      for (int i = 0;
        ...
        if (_appointmentExpertModel!
          ...
          generalAppointment++;
            ...
            'video consultations') {
          videoAppointment++;
          log("no of video appoint $videoAppointment");
        }
      }
                                                              ...
                                                              addReminderDialog(
                                                                ...
                                                                title: _appointmentExpertModel!
                                                                    ...
                                                                    .appointmentServiceexpertDtl![
                                                                        0]
                                                                    .serviceName!,
                                                                addressLine1: _appointmentExpertModel!
                                                                    .appointmentexpertDetails![
                                                                        index]
                                                                    .centerCode!,
                                                                addressLine2: _appointmentExpertModel!
                                                                    .appointmentexpertDetails![
                                                                        index]
                                                                    .centerName!,
                                                                // appointmentDate: _appointmentExpertModel!
