...
ExertProfileModel exertProfileModelFromJson(String str) => ExertProfileModel.fromJson(json.decode(str));

String exertProfileModelToJson(ExertProfileModel data) => json.encode(data.toJson());
...
class ExertProfileModel {
    ...
    factory ExertProfileModel.fromJson(Map<String, dynamic> json) => ExertProfileModel(
        status: json["Status"],
...
class StaffDetails {
    ...
    Map<String, dynamic> toJson() => {
        ...
        "StaffDateofBirth": "${staffDateofBirth!.year.toString().padLeft(4, '0')}-${staffDateofBirth!.month.toString().padLeft(2, '0')}-${staffDateofBirth!.day.toString().padLeft(2, '0')}",
