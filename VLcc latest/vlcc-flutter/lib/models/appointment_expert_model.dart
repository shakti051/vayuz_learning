...
AppointmentExpertModel appointmentExpertModelFromJson(String str) => AppointmentExpertModel.fromJson(json.decode(str));

String appointmentExpertModelToJson(AppointmentExpertModel data) => json.encode(data.toJson());
...
class AppointmentExpertModel {
    ...
    factory AppointmentExpertModel.fromJson(Map<String, dynamic> json) => AppointmentExpertModel(
        status: json["Status"],
        message: json["Message"],
        appointmentexpertDetails: List<AppointmentexpertDetail>.from(json["AppointmentexpertDetails"].map((x) => AppointmentexpertDetail.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "Status": status,
        "Message": message,
        "AppointmentexpertDetails": List<dynamic>.from(appointmentexpertDetails!.map((x) => x.toJson())),
    };
}
...
class AppointmentexpertDetail {
    ...
    factory AppointmentexpertDetail.fromJson(Map<String, dynamic> json) => AppointmentexpertDetail(
        ...
        appointmentServiceexpertDtl: List<AppointmentServiceexpertDtl>.from(json["AppointmentServiceexpertDtl"].map((x) => AppointmentServiceexpertDtl.fromJson(x))),
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "AppointmentServiceexpertDtl": List<dynamic>.from(appointmentServiceexpertDtl!.map((x) => x.toJson())),
    };
}
...
class AppointmentServiceexpertDtl {
    ...
    factory AppointmentServiceexpertDtl.fromJson(Map<String, dynamic> json) => AppointmentServiceexpertDtl(
