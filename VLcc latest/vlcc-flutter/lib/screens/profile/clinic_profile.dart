...
import 'package:vlcc/screens/appointments/select_service.dart';
...
class _ClinicProfileBookingState extends State<ClinicProfileBooking>
    ...
    setState(() {
      ...
      _markers.add(Marker(
        ...
        infoWindow: InfoWindow(
          title: widget.centerMasterDatabase.addressLine1,
  ...
  Future<void> launchMail() async {
    String url = "mailto:gk.dl@vlccwellness.com";
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        ...
        headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
          return [
            SliverAppBar(
              // collapsedHeight: screenSize.height * 0.3,
              snap: true,
              bottom: TabBar(
                  ...
                  children: [
                    Padding(
                      ...
                      child: InkWell(
                        onTap: () {
                          launchCentre(
                              url: widget.centerMasterDatabase.centerMap);
                        },
                        child: Container(
                          padding: EdgeInsets.all(PaddingSize.small),
                          decoration: BoxDecoration(
                    ...
                    children: [
                      ...
                      Column(
                        children: [
                          ...
                          Padding(
                            padding:
                                const EdgeInsets.only(top: 200, bottom: 20),
                            child: clinicCard(),
                          ),
                          Expanded(child: SizedBox()),
                        ],
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            HeadingTitleText(
                fontSize: FontSize.extraLarge, title: serviceCategory),
          ],
        ),
        bookingList(
