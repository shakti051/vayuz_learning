...
class _ConsumerBottomBarState extends State<ConsumerBottomBar> {
  ...
  void initState() {
    ...
    log(_vlccShared.isFirstTimeLogin.toString(), name: 'islogin coach');
    if (_vlccShared.isFirstTimeLogin ?? false) {
      Future.delayed(Duration(seconds: 0), _showTutorial);
    }
  }
  ...
  void _showTutorial() {
    ...
    tutorialCoachMark = TutorialCoachMark(
      ...
      onFinish: () {
        ...
        log("finish", name: 'coach');
      },
      onClickTarget: (target) {
        _vlccShared.isFirstTimeLoginOnDevice(withValue: false);
        log('onClickTarget: $target', name: 'coach');
      },
      onClickOverlay: (target) {
        _vlccShared.isFirstTimeLoginOnDevice(withValue: false);
        log('onClickOverlay: $target', name: 'coach');
      },
      onSkip: () {
        _vlccShared.isFirstTimeLoginOnDevice(withValue: false);
        log("skip", name: 'coach');
