...
import 'appoiment_requested.dart';
...
class _SelectServiceState extends State<SelectService> {
  ...
  //       centerCode = profileModel.clientProfileDetails.centerCode;
  //     });
  //   });
  // }
  ...
  void initState() {
    super.initState();
    setState(() {
      tme = '$finalHour:$finalMinute $finalPeriod';
    });
  ...
  Future<void> _selectTime(BuildContext context,
    ...
    // setState(() {
    //   _minuteScrollController.animateToItem(_minuteIndex,
    //       duration: Duration(milliseconds: 200), curve: Curves.ease);
    //   _hourScrollController.animateToItem(_minuteIndex,
    //       duration: Duration(milliseconds: 200), curve: Curves.ease);
    // });
    var initHour = 7;
    var period = ['AM', 'PM'];
    ...
    var hours = List.generate(12, (index) {
      initHour = initHour + 1;
      return hourConverter(initialTime: initHour);
    });
    picked = await showDialog(
                        ...
                        Expanded(
                          child: CupertinoPicker(
                            ...
                            onSelectedItemChanged: (value) {
                              _hourIndex = value;
                              // if (hours[value] == 8) {
                              //   dashboardProvider.isAmPm = false;
                              // } else {
                              //   dashboardProvider.isAmPm = true;
                              // }
      ...
      _periodScrollController = FixedExtentScrollController(initialItem: 0);
    });
  }

  int hourConverter({required int initialTime}) {
    if (initialTime == 0) {
      return 12;
                ...
                children: [
                  ...
                  GradientButton(
                    onPressed: () {
                      ...
                      if (dashboardProvider.centerName.isEmpty) {
                        final snackBar = SnackBar(
                          content: Text(
                      ...
                      if (widget.isBookViaPackage) {
                        ...
                        if (dashboardProvider.centerName == '' &&
                            widget.isFromSearch) {
                          final snackBar = SnackBar(
                            content: Text(
                              'Please select a center to proceed.',
                        ...
                        if ((!widget.isFromSearch ||
                          ...
                          dashboardProvider.centerName = '';
                          cashBook(
                                  centerMasterDatabase: !widget.isFromSearch
                                ...
                                children: [
                                  ...
                                  Visibility(
                                    visible: !widget.isBookViaPackage &&
                                        profileProvider.servicePrice != '',
                                    child: Text(
                                      'Subtotal: Rs. ${profileProvider.servicePrice}',
                                      style: TextStyle(
