...
class AppoimentRequested extends StatefulWidget {
  final String serviceName;
  final String centerName;
  final String date;
  final String time;
  final bool willConsultPrice;
  const AppoimentRequested(
      {Key? key,
      required this.date,
      required this.time,
  ...
  @override
  State<AppoimentRequested> createState() => _AppoimentRequestedState();
}

class _AppoimentRequestedState extends State<AppoimentRequested> {
  @override
